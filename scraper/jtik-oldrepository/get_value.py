...
for _, row in df.iterrows():
    ...
    div_2 = driver.find_element(By.CLASS_NAME, "col-md-12.keywords-doc")
    
    data_judul = div_1.find_element(By.TAG_NAME, "h4").text
    data_abstrak = div_1.find_element(By.TAG_NAME, "p").text
    data_kata_kunci = div_2.find_element(By.TAG_NAME, "li").text
...
df.to_csv("data_oldrepo_jtik.csv", index=False)
